---
title: "Deriving the hyperbola binding equation"
...
This documentation explains how the hyperbola binding equation used to fit
...
## Deriving the hyperbola binding equation
...
## Using the hyperbola binding equation to fit a binding curve
...
series at given values of $L_{tot}$. The experimental data is, indeed,
$S = f(L_{tot})$. $L_{tot}$ is a known experimental parameter. Therefore, $K_D$
and $S_{max}$ can be determined by fitting equation 6 to the experimental data.
