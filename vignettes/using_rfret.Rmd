...
package to analyze FRET titration experiments and determine the binding constant
(Kd) of a macromolecular interaction. An example using a real-life dataset is
